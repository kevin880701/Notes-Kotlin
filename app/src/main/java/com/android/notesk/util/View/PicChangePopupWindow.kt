...
import com.android.notesk.util.View.EditFileActivity.Companion.isChangePic
import com.android.notesk.util.View.EditFileActivity.Companion.isPicExists

class PicChangePopupWindow(mContext: Context, addPic : ImageView, isPicExists: Boolean) : PopupWindow(), View.OnClickListener {
...
//            picBtn!!.setBackgroundDrawable(getResources().getDrawable(R.drawable.radius3))
    ...
    fun delBtnClicked() {
        isChangePic = true
        isPicExists = false
        addPic.setImageDrawable(mContext.getDrawable(R.drawable.none))
        dismiss()
    }
